"""
Django settings for pawpals_project project.
...
# Use dynamic path to improve portability
...
ROOT_URLCONF = 'pawpals_project.urls'
...
WSGI_APPLICATION = 'pawpals_project.wsgi.application'
